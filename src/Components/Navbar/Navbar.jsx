...
const Navbar = () => {
    return (
    <div className="mt-[20px] mt-[40px] lg:mx-[100px]">
  ...
  <div className="navbar-start">
    ...
    <a className="btn text-2xl btn-ghost lg:text-4xl text-">DeviantArt</a>
  </div>
  <div className="navbar-center hidden lg:flex">
    <ul className="menu   menu-horizontal px-1">
     ...
     <li className="ml-[16px]"> <NavLink>My Art&Carft List</NavLink></li>
